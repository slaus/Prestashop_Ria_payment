...
<div class="alert alert-message"> 
 <center><p class="clear">{l s='For a full version of this module, with auto installation, and confirmation when customer make the payment, check WesterUnion+:' mod='riapayment'}<a href="http://catalogo-onlinersi.net/en/home/475-western-union-prestashop.html" target="_blank">Link</a></p></center>
