...
class RiaPaymentValidationModuleFrontController extends ModuleFrontController
{
	public function postProcess()
	{
		...
		$this->module->validateOrder((int)$cart->id, Configuration::get('RIAPAYMENT_STATE1'), $total, $this->module->displayName, NULL, $mailVars, (int)$currency->id, false, $customer->secure_key);
