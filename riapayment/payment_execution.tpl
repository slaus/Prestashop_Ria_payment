...
<p>
	...
	{if $currencies|@count > 1}
		{l s='We accept several currencies to be sent by Ria Payment.' mod='riapayment'}
		<br /><br />
	...
	{else}
		{l s='We accept the following currency to be sent by Ria Payment:' mod='riapayment'}&nbsp;<b>{$currencies.0.name}</b>
		<input type="hidden" name="currency_payement" value="{$currencies.0.id_currency}">
	{/if}
</p>
<p>
	{l s='Ria Payment account information will be displayed on the next page.' mod='riapayment'}
	<br /><br />
	<b>{l s='Please confirm your order by clicking \'I confirm my order\'' mod='riapayment'}.</b>
</p>
<p class="cart_navigation">
	<a href="{$base_dir_ssl}order.php?step=3" class="button_large">{l s='Other payment methods' mod='riapayment'}</a>
